...
public class Driver_Account_Reg_Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_driver_account_reg);
        ...
        try {
            ...
            String ref = "DriverUserData/" + uid;

            DDUserInfo = new DUserInfo();
            databaseReference = firebaseDatabase.getReference(ref);

        } catch (Exception e) {
            Toast.makeText(Driver_Account_Reg_Activity.this, "UID receiver Error", Toast.LENGTH_SHORT).show();
        }
        ...
        b1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (name.equals("") || age.equals("") || city.equals("")) {
                    Toast.makeText(Driver_Account_Reg_Activity.this, "Please Fill all the fields", Toast.LENGTH_SHORT).show();
                } else {
        ...
        databaseReference.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                try {
                    ...
                    Toast.makeText(Driver_Account_Reg_Activity.this, "Registration Completed", Toast.LENGTH_SHORT).show();
                    ...
                    editor.apply();
                    Intent i = new Intent(Driver_Account_Reg_Activity.this, Home_Activity.class);
                    startActivity(i);
                } catch (Exception e) {
                    Toast.makeText(Driver_Account_Reg_Activity.this, "User Exists", Toast.LENGTH_SHORT).show();
                }
            ...
            public void onCancelled(@NonNull DatabaseError error) {
                ...
                Toast.makeText(Driver_Account_Reg_Activity.this, "Fail to add data " + error, Toast.LENGTH_SHORT).show();
            }
        });
    }
}